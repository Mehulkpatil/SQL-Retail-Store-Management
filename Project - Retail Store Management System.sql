...
CREATE TABLE Orders (
    ...
    Remarks_if_any VARCHAR(255) DEFAULT 'No Remarks',
...
--Get orders of customers who have spent more_than₹900.

select * from orders
where total_amount > 900;

/* Find the two most expensive products from_the Products_table. */
